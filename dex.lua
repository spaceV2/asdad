...
Main = (function()
	...
	Main.FetchAPI = function()
		...
		if Main.Elevated then
			...
			rawAPI = rawAPI or HttpGet("http://setup.roblox.com/"..Main.RobloxVersion.."-API-Dump.json")
		else
	...
	Main.FetchRMD = function()
		...
		if Main.Elevated then
			...
			rawXML = rawXML or HttpGet("https://raw.githubusercontent.com/CloneTrooper1019/Roblox-Client-Tracker/roblox/ReflectionMetadata.xml")
		else
	...
	Main.Init = function()
		...
		if Main.Elevated then
			...
			Main.RobloxVersion = Main.RobloxVersion or HttpGet("http://setup.roblox.com/versionQTStudio")
		end
