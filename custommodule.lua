...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		return HttpGet("https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/main/"..scripturl, true)
	end
end
	...
	task.spawn(function()
		pcall(function()
			if not isfile("vape/Profiles/bedwarsdata.txt") then
				local commit = "main"
				for i,v in pairs(HttpGet("https://github.com/7GrandDadPGN/VapeV4ForRoblox"):split("\n")) do
				...
				writefile("vape/Profiles/bedwarsdata.txt", HttpGet("https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/"..commit.."/CustomModules/bedwarsdata", true))
			end
			...
			repeat
				...
				local newdata = HttpGet("https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/"..commit.."/CustomModules/bedwarsdata", true)
